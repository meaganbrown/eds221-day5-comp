...
# The line below...creates a sequence of years from 0 - 8 years
time_yr <- seq(from = 0, to = 8, by = 1)

# The line below...creates a matrix of the projected year with year 0 as column and the sequence of years created above as rows
proj_year <- matrix(ncol = length(fish_year0), nrow = length(time_yr))

# The line below...defines year 0 as the 1st row in the matrix
...
ggplot(data = proj_df, aes(x = time_yr, 
                           y = stage_population)) +
